...
<div class="container">
	...
	<div class="panel panel-default">
  	<div class="panel-heading">Add New Frame</div>
	...
	<form action="" method="post" class="form-horizontal">
	  ...
	  <div class="form-group">
	    <label for="frame_serial_no" class="col-md-3 control-label">Serial No</label>
	    <div class="col-md-9">
	 ...
	 <div class="form-group">
	  ...
	  <div class="form-group">
	    <label for="qty" class="col-md-3 control-label">Qty in hand</label>
	    <div class="col-md-9">
	  ...
	  <div class="col-md-9">
	  <button type="submit"  name ="btnSave" class="btn btn-primary btn-md btn-large">Submit</button>
	  <a class="btn btn-primary btn-md btn-large" href="<?php echo site_url('frames/index')?>" role="button">Cancel</a>
	  </div>
	  </div>
	</form>
