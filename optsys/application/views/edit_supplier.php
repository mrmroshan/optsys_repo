...
<form action="" method="post" class="form-horizontal">
	...
	<div class="form-group">
	    <label for="company_name" class="col-md-6 control-label">Company Name</label>
	    <div class="col-md-6">
	  ...
	  <div class="form-group">
		<label for="contact_person" class="col-md-6 control-label">Contact Person</label>
		<div class="col-md-6">
	  ...
	  <div class="form-group">
	    <label for="phone_no" class="col-md-6 control-label">Phone No</label>
	    <div class="col-md-6">
