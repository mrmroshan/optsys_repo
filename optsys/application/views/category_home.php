...
<div class="modal fade" id="del_conf" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
	...
	<a class="btn btn-primary" href="<?php echo site_url('/categories/add')?>" role="button">Add New</a>
	</dir>
...
mygrid.setHeader    ("Action ,Category Id, Product Type,Category   ,Details");
mygrid.setColSorting("str    ,int        ,str          ,str        ,str");
mygrid.setInitWidths("80     ,50         ,80         ,200          ,200");
mygrid.setColAlign("center   ,left      ,left        ,left         ,left");
mygrid.setColTypes("ro,ro,ro,ro,ro");
mygrid.init();
mygrid.load("<?php echo site_url("/categories/produce_grid_feed/1000/0")?>");
        ...
        $.ajax({
            ...
            success: function(data, status){
                	if(data == 1){               
                		...
                		mygrid.clearAndLoad("<?php echo site_url("/categories/produce_grid_feed/1000/0")?>");           
                    }else{
